...
Para obtener instrucciones detalladas, se puede visitar la documentación oficial de GeoAgent [@wu2026geoagent]: [https://geoagent.gishub.org/qgis-plugin/](https://geoagent.gishub.org/qgis-plugin/)
:::

![Pantallazo del Panel de Configuración de OpenGeoAgent](images/pantallazo_config.png)
...
## Tarea 1: Localización y Encuadre (Modo: General QGIS)

**Objetivo:** Centrar el proyecto en la zona de estudio (Vegachí y Remedios, Antioquia) para definir el área de influencia de las consultas posteriores en la nube.

* **Modo de Agente:** `General QGIS`
* **Prompt Usado:**

> "Search for the municipalities of 'Vegachí' and 'Remedios' in Antioquia, Colombia. Zoom the map canvas to an extent that encompasses both administrative boundaries. Once positioned, create a temporary scratch polygon layer named 'Study_Area_Buffer' that represents this bounding box to use as a spatial reference for the following analysis."

![Lienzo de QGIS mostrando el encuadre de la zona de estudio como resultado del prompt](images/evidencia_tarea1.png)

## Tarea 2: Adquisición de Datos (Modo: GEE Data Catalogs)
...
![Lienzo de QGIS mostrando las capas DEM y GHI cargadas](images/evidencia_tarea2.png)

Las tareas siguientes se enfocan en el análisis geomorfométrico y la simulación de sombreado, utilizando los datos adquiridos para evaluar la aptitud del terreno para la instalación de paneles solares. Estas tareas se realizarán en etapas posteriores, utilizando los modos de agente correspondientes para cada tipo de análisis, una vez que se tengan modelos de elevación con la resolución adecuada para la zona de estudio, por lo cual, preliminarmente se dejan planteadas.

## Tarea 3: Derivación Geomorfométrica (Modo: General QGIS)
...
## Tarea 4: Simulación de Sombreado Solar (Modo: WhiteboxTools)
...
Evaluación Multicriterio Dinámica: A diferencia de las evaluaciones estáticas, el uso de modos específicos (General QGIS y WhiteboxTools) facilita la creación rápida mediante prompts formulados, de máscaras booleanas y simulaciones de sombreado, demostrando ser una aproximación robusta para delimitar áreas físicamente viables.
